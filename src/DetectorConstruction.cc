...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    std::vector<double> pmtWaveLengthBin = {298.734, 303.567, 310.472, 317.376, 328.423, 338.78, 360.184, 380.207,
                                            398.159, 414.039, 447.871, 461.68, 483.084, 495.512, 512.083, 523.82,
                                            538.32, 547.986, 559.724, 567.319, 581.818, 596.318, 610.127, 621.864,
                                            632.221, 642.578, 652.244, 658.458, 668.815, 677.1, 685.386, 694.361,
                                            701.266, 710.242, 718.527, 724.051};

    std::vector<double> pmtQuantumEfficiency = {5.286, 8.887, 12.769, 15.15, 19.511, 22.678, 26.359, 27.841,
                                                27.841, 26.18, 23.148, 21.179, 18.472, 16.558, 13.956, 12.34,
                                                9.915, 8.648, 6.901, 5.978, 4.335, 2.956, 2.002, 1.337,
                                                0.899, 0.593, 0.393, 0.289, 0.173, 0.115, 0.076, 0.05,
                                                0.033, 0.022, 0.015, 0.011}; // CR284
